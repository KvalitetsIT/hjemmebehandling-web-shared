...
class ResponseViewCard extends react_2.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(material_1.Card, null,
            react_1.default.createElement(material_1.CardHeader, { action: react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    react_1.default.createElement(material_1.Button, { sx: { fontWeight: tableButtonWeight }, onClick: () => this.setState({ displayType: DisplayModeEnum.TABLE }) }, "Liste")), subheader: react_1.default.createElement(material_1.Typography, { variant: "h6", fontWeight: "bold" }, chartData.label) }),
            react_1.default.createElement(material_1.Divider, null),
            react_1.default.createElement(material_1.CardContent, null,
                this.state.displayType == DisplayModeEnum.GRAPH ? react_1.default.createElement(QuestionChart_1.QuestionChart, { chartData: chartData }) : react_1.default.createElement(react_1.default.Fragment, null),
